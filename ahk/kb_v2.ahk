...
; App launch/activate
actions["ms"] := (*) => ActivateOrRunExe(r"C:\Program Files (x86)\Microsoft SQL Server\120\Tools\Binn\ManagementStudio\Ssms.exe")
actions["vs"] := (*) => ActivateOrRunExe(r"C:\Program Files\Microsoft Visual Studio\2022\Professional\Common7\IDE\devenv.exe")
actions["vc"] := (*) => ActivateOrRunExe(r"C:\Users\mhe\AppData\Local\Programs\Microsoft VS Code\Code.exe")
actions["eg"] := (*) => ActivateOrRunExe(r"C:\Program Files (x86)\Microsoft\Edge\Application\msedge.exe")
actions["wt"] := (*) => ActivateOrRunClass("CASCADIA_HOSTING_WINDOW_CLASS", r"C:\Users\mhe\AppData\Local\Microsoft\WindowsApps\wt.exe")
actions["ch"] := (*) => ActivateOrRunClass("Chrome_WidgetWin_1", r"C:\Program Files (x\86)\Google\Chrome\Application\chrome.exe")
actions["vm"] := (*) => ActivateOrRunClass("Vim", r"C:\Program Files\Vim\vim91\gvim.exe")
actions["ol"] := (*) => ActivateOrRunExe(r"C:\Program Files\Microsoft Office\root\Office16\OUTLOOK.EXE")
...
+CapsLock:: {
    ...
    ib := InputBox("Enter action token:\n" tokens, "AHK v2 Actions", "w420 h160")
    if ib.Result = "OK" {
        token := Trim(ib.Value)
